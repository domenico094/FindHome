				...
				<div class="container ">
					...
					<div class="collapse navbar-collapse" id="navbarNavDropdown">
						...
						<c:if test="${username!=null }">
							...
							<c:if test="${username!=null && bannato == true}">
								<a class="btn myButton" href="faiLogout" > Log out</a>
							</c:if>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="section-title">
						<h2>Annunci</h2>
						<p>
							Gli ultimi annunci inseriti <a href="/elencoAnnunci">vedi
								tutti >></a>
						</p>
					</div>
				</div>
				<div class="col-lg-8">
					<div id="ultimiAnnunci" class="row"></div>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="section-title " data-aos="fade-right">
						<h2>Venditori</h2>
						<p>
							Gli ultimi venditori iscritti <a href="/elencoVenditori">vedi
								tutti >></a>
						</p>
					</div>
				</div>
				<div class="col-lg-8">
					<div id="ultimiVenditori" class="row"></div>
