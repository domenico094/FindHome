			...
			<div class="row">
				<div class="col-lg-4">
					<div class="section-title">
						<h2>Venditori</h2>
              <p> elenco di tutti i venditori</p>
			
              <p> 	<select class="selectOption" name='tipo ordine' id="campoSortVenditore">
				...
				<option value='cognomeDecrescente'>cognome Decrescente</option>
				<option value='usernameCrescente'>username crescente</option>
				<option value='usernameDecrescente'>username Decrescente</option>
				<option value='idCrescente'>id crescente</option>
				<option value='idDecrescente'>id Decrescente</option>

			</select>	<a  id="btnOrdinaVenditore" class="btn myButton">ordina</a></p>
...
<footer class="footer">
	...
	<script type="text/javascript" src="../js/elenco_venditori.js"></script>
