			...
			<div class="row">
					<div class="col-lg-3">
						<div class="section-title " data-aos="fade-right">
							<h2>I tuoi Ordini</h2>
							<p> Qui ci sono gli annunci che hai aggiunto al carrello</p>
							<button class="btn btn-primary" type="button"
								data-bs-toggle="collapse"
								data-bs-target="#collapseExampleOrdini"
								aria-expanded="false"
								aria-controls="#collapseExampleOrdini">Vedi >>
							</button>
					...
					<div class="col-lg-9">
						<div class="collapse" id="collapseExampleOrdini">
							<div class="card card-body">
								<div class="tbodyDiv">
									<form method="GET" action="/provaaa">
										<table id="ordini_tabella" class="table table-striped ">
								...
								<div class="conteiner">
									<div class="row">
										...
										<div class="col-lg-8">
										<button class="btn btn-danger" id="btnCancellaOrdine">
							Cancella</button>
<button id="checkOut" type="button" class="btn btn-primary"
							data-bs-toggle="modal" data-bs-target="#exampleModalPaga"
							>
							Seleziona e Paga <i class="fas fa-credit-card"></i>
						</button>
						<div id="totale"></div>
						<!-- Modal -->
						<div class="modal fade" id="exampleModalPaga" tabindex="-1"
							aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Inserisci il
									...
									<div class="modal-body">
										...
										<form id="form1" action="">
											<div class="row mb-12">
												<div class="col">
													<div class="form-outline">
														<input type="text" id="campoNumeroCarta" class="form-control" />
														<label class="form-label" for="campoNumeroCarta">NumeroCarta</label>
													</div>
												</div>
											...
											<div class="row mb-4">
												<div class="col">
													<div class="form-outline">
														...
														<label class="form-label" for="campoMeseScadenza">Mese Scadenza</label>
													</div>
												</div>
												<div class="col">
													<div class="form-outline">
														...
														<option value="2028">2028</option>
																												...
																												<label class="form-label" for="campoAnnoScadenza">Anno Scadenza</label>
													</div>
												</div>
												<div class="col">
													<div class="form-outline">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-danger"
												data-bs-dismiss="modal">Close</button>
											<div class="col">
												<button id="btnAggiungiPaga" class="btn btn-warning">
													Paga <i class="fas fa-credit-card"></i></button>
											</div>
										</div>
									</div>
								</div>
...
<footer class="footer">
	...
	<script type="text/javascript" src="../js/ordine.js"></script>
