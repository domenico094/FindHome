			...
			<div class="row">
				<div class="col-lg-4 aos-init aos-animate" data-aos="fade-right">
					<div class="section-title">
						<h2>Contatti</h2>
						<p> Qui puoi vedere i nostri contatti e dove trovarci</p>
					</div>
				</div>
				...
				<div class="col-lg-8 aos-init aos-animate" data-aos="fade-up"
					...
					<div id="map" style="width: 100%; height: 270px; border: 0;"></div>
					<div class="info mt-4">
						<i class="fas fa-map-marked-alt"></i>
						<h4>Location:</h4>
						<p>Unical, Rende, CS, Italia</p>
					</div>
					<div class="row">
